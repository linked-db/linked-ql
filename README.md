...
*Dynamically compose a <code>CREATE DATABASE</code> query.*
...
*Dynamically compose an <code>ALTER DATABASE</code> query.*
...
*Dynamically compose a <code>DROP DATABASE</code> query.*
