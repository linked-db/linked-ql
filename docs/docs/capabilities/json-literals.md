...
### Grouping Rules (PostgreSQL & MySQL)
...
An exception to this rule appears in [DeepRefs](deeprefs#backrefs) — where the aggregation syntax isolates its own grouping semantics from the main query.
