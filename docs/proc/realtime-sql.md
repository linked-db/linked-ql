...
*Turn on reactivity over arbitrary SQL.*
...
* [Realworld Overview](#realworld-overview)
* [` 1 |` Live Views in Detail](#-1--live-views-in-detail)
  * [`1.1 |` Joins and Composites](#11--joins-and-composites)
  * [`1.2 |` Frames and Ordinality](#12--frames-and-ordinality)
  * [`1.3 |` Precision and Granularity](#13--precision-and-granularity)
  * [`1.4 |` Observability and Atomicity](#14--observability-and-atomicity)
  * [`1.5 |` Live Bindings](#15--live-bindings)
* [` 2 |` Event Callbacks](#-2--event-callbacks)
* [` 3 |` Query Inheritance](#-3--query-inheritance)
  * [`3.1 |` Scaling Behavior](#31--scaling-behavior)
...
### `1.4 |` Observability and Atomicity
