const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.CDfL2ecO.js","assets/chunks/framework.DNT4b13o.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$j = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.CDfL2ecO.js"), true ? __vite__mapDeps([0,1]) : void 0));
