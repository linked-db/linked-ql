...
import AbstractUpdateQueryInspector from '../abstracts/AbstractUpdateQueryInspector.js';

/**
 * ---------------------
 * The SQLUpdateQueryInspector class
 * ---------------------
 */
export default class SQLUpdateQueryInspector extends AbstractUpdateQueryInspector {
