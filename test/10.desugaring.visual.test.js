...
$describe('DeSugaring - Expr DeSugaring', () => {
    ...
    $describe('SelectElement', () => {
        ...
        $it('should parse an "SelectElement" expr with an aggregation syntax - Postgres', async () => {
            ...
            await testParseAndStringify('BasicSelectStmt', [inputSql, outputSql], { deSugar: true, dialect: 'postgres' }, dbContext);
        });
        ...
        $it('should parse an "SelectElement" expr with an aggregation syntax - MySQL', async () => {
            ...
            await testParseAndStringify('BasicSelectStmt', [inputSql, outputSql], { deSugar: true, dialect: 'mysql' }, dbContext);
        });
    ...
    $describe('LQObjectLiteral As Root Select List', () => {
        $it('should parse an "SelectStmt" with un-aliased LQObjectLiteral as root select list - Postgres', async () => {
            ...
            await testParseAndStringify('SelectStmt', [inputSql, outputSql], { deSugar: true, dialect: 'postgres' }, dbContext);
        });
        ...
        $it('should parse an "SelectStmt" with un-aliased LQObjectLiteral as root select list - MySQL', async () => {
            ...
            await testParseAndStringify('SelectStmt', [inputSql, outputSql], { deSugar: true, dialect: 'mysql' }, dbContext);
        });
    });
});
...
$describe('DeSugaring - Refs Resolution', () => {
    ...
    $describe('TableRef1', () => {
        $it('should parse a bare "TableRef1" to a fully-qualified TableRef1', async () => {
            ...
            await testParseAndStringify('TableRef1', [inputSql, outputSql], { deSugar: true }, dbContext);
        });
    });
    ...
    $describe('ColumnRef1', () => {
        $it('should parse and fully-qualify a bare "ColumnRef1"', async () => {
            ...
            await testParseAndStringify('BasicSelectStmt', [inputSql, outputSql], { deSugar: true }, dbContext);
        });
...
FROM public.users`;
            await testParseAndStringify('BasicSelectStmt', [inputSql, outputSql], { deSugar: true, prettyPrint: true }, dbContext);
        });
    });
});
...
VALUES
  ...
  ('dffff', ROW (5, 2000))`;
            ...
            await testParseAndStringify('InsertStmt', [inputSql, outputSql], { deSugar: true, prettyPrint: true }, dbContext);
        });
...
VALUES
  ...
  ('dffff', 333)`;
            ...
            await testParseAndStringify('UpsertStmt', [inputSql, outputSql], { deSugar: true, prettyPrint: true }, dbContext);
        });
    });
});
...
SET
  ...
  (username, parent_user1 ~> id) = (232, 3445)`;
            ...
            await testParseAndStringify('UpdateStmt', [inputSql, outputSql], { deSugar: true, prettyPrint: true }, dbContext);
        });
...
WHERE (parent_user2 <~ parent_user2 <~ users) ~> id = 3`;
            ...
            await testParseAndStringify('DeleteStmt', [inputSql, outputSql], { deSugar: true, prettyPrint: true }, dbContext);
        });
    });
});