...
VALUES
  ...
  ('dffff', 333)`;
            ...
            await testParseAndStringify('UpsertStmt', [inputSql, outputSql], { deSugar: 2, prettyPrint: true }, linkedDb);
        });
    });
});
...
WHERE (parent_user2 <~ parent_user2 <~ users) ~> id = 3`;
            ...
            await testParseAndStringify('DeleteStmt', [inputSql, outputSql], { deSugar: 2, prettyPrint: true }, linkedDb);
        });
    });
});